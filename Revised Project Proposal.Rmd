...
- Population density of each state/city (numeric)
- Size of police force within the state (numeric)
- Police per capita (numeric)
- Demographic of police force in the state/city (numeric, presented by the distribution of race/ethnicity across the police force. Ex: white: 50%, black 30% etc…)
